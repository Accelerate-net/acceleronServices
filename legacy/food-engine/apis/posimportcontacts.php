...
$rows = mysql_fetch_assoc(mysql_query("SELECT * FROM z_customers_master WHERE flag = 0 AND mobile != '' ".$filter." LIMIT 1"));
...
mysql_query("UPDATE `z_customers_master` SET `flag`= 1 WHERE `mobile` = '{$rows['mobile']}'");    
